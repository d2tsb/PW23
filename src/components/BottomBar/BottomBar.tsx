    ...
    <div className='bottom-bar'>
      <ul className='bottom-bar__elements'>
        <li className='bottom-bar__element'>
          <Link className='bottom-bar__element' to='/impressum'>
            {bottomBarOptions[language]}
          </Link>
        </li>

        <div className='onHoverImgDiv'>
          <a href={'https://github.com/d2tsb/PW23'} className='bottom-bar__link'>
            <div className='bottom-bar__image-div'>
              <img className='bottom-bar__image' src={imageMap.githubLogo} alt='git logo '></img>
